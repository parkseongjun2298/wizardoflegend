...
{
	const TEX_INFO* pTexInfo = m_pTextureMgr->GetTexInfo(L"Ui", L"Player_Bar", (int)m_fFrameStart);
	NULL_CHECK(pTexInfo);
...
HRESULT CPlayerBar::Initialize()
{
	m_tInfo.vSize = { 1.f, 1.f, 0.f };
	m_tInfo.vInitialDir = { 0.f, -1.f, 0.f };
	m_tInfo.vPos = { 100,50,0 };
	// 항등행렬 함수. (행렬 초기화)
...
CPlayerBar * CPlayerBar::Create()
{
	CPlayerBar* pInstance = new CPlayerBar;
