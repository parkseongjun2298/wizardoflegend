...
{
	const TEX_INFO* pTexInfo = m_pTextureMgr->GetTexInfo(L"Ui", L"Teleport", (int)m_fFrameStart);
	NULL_CHECK(pTexInfo);
...
HRESULT CTeleport::Initialize()
{
	m_tInfo.vSize = { 1.f, 1.f, 0.f };
	m_tInfo.vInitialDir = { 0.f, -1.f, 0.f };
	//m_tInfo.vPos = { 2600,1920,0 };
	// 항등행렬 함수. (행렬 초기화)
...
CTeleport * CTeleport::Create(float _X,float _Y)
{
