...
void CMathMgr::MyTransformCoord(
	D3DXVECTOR3* pOut, const D3DXVECTOR3* pIn, const D3DXMATRIX* pMat)
{
	D3DXVECTOR4 vTemp = { pIn->x, pIn->y, pIn->z, 1.f };

	pOut->x = vTemp.x * pMat->_11 + vTemp.y * pMat->_21
		+ vTemp.z * pMat->_31 + vTemp.w * pMat->_41;
	pOut->y = vTemp.x * pMat->_12 + vTemp.y * pMat->_22
		+ vTemp.z * pMat->_32 + vTemp.w * pMat->_42;
	pOut->z = vTemp.x * pMat->_13 + vTemp.y * pMat->_23
		+ vTemp.z * pMat->_33 + vTemp.w * pMat->_43;
}

void CMathMgr::MyTransformNormal(
	D3DXVECTOR3* pOut, const D3DXVECTOR3* pIn, const D3DXMATRIX* pMat)
{
	D3DXVECTOR4 vTemp = { pIn->x, pIn->y, pIn->z, 0.f };
